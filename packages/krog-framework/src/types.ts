...
export type ModalOperator =
  | 'P'   // Permission - action is permitted
  | 'O'   // Obligation - action is required
  | 'F'   // Prohibition - action is forbidden (derived: F ≡ O¬ ≡ ¬P)
  | 'C'   // Claim - player can claim a right
  | 'L'   // Liberty - player has freedom to act
  | 'W'   // Power - ability to perform action
  | 'B'   // Immunity - protection from action
  | 'I'   // Disability - cannot perform action
  | 'D';  // Liability - subject to consequence
