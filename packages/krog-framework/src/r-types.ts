 ...
 * T₇    | ... | ... | ... | ... | ... | ... | R₇  |
 */
export const RTypeMatrix: Record<TType, Record<TType, RType>> = {
...
export const RTypeDefinitions: Partial<Record<RType, RTypeDefinition>> = {
 ...
 */
export function getRType(agent1: TType, agent2: TType): RType {
 ...
 */
export function getRTypeDefinition(rtype: RType): RTypeDefinition | undefined {
 ...
 */
export function isSymmetric(rtype: RType): boolean {
  const symmetric: RType[] = ['R1', 'R2', 'R3', 'R4', 'R5', 'R6', 'R7'];
 ...
 */
export function getAsymmetry(rtype: RType): number {
 ...
 */
export function getRisk(rtype: RType): 'low' | 'medium' | 'high' | 'very_high' {
  const def = RTypeDefinitions[rtype];
 ...
 */
export function shouldAvoid(rtype: RType): boolean {
  const conflictTypes: RType[] = ['R26', 'R13'];
