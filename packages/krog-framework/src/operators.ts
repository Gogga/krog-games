...
export const OperatorDefinitions: Record<ModalOperator, OperatorDefinition> = {
  P: {
    symbol: 'P',
 ...
 */
export function getOperatorDefinition(op: ModalOperator): OperatorDefinition {
 ...
 */
export function getDual(op: ModalOperator): ModalOperator | undefined {
 ...
 * P(φ) ≡ ¬O¬(φ)
 */
export function permissionFromObligation(obligatedNot: boolean): boolean {
  return !obligatedNot;
}
 ...
 * O(φ) ≡ ¬P¬(φ)
 */
export function obligationFromPermission(permittedNot: boolean): boolean {
  return !permittedNot;
}
 ...
 * F(φ) ≡ O¬(φ) ≡ ¬P(φ)
 */
export function prohibitionFromPermission(permitted: boolean): boolean {
  return !permitted;
}
 ...
 * L(i,φ) ≡ ¬D(i,¬φ)
 */
export function libertyFromDuty(dutyNot: boolean): boolean {
  return !dutyNot;
}
 ...
 * I(i,φ) ≡ ¬W(i,φ)
 */
export function disabilityFromPower(hasPower: boolean): boolean {
  return !hasPower;
}
